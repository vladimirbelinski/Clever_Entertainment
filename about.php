		...
		<div class="container">
			<div class="section">
				<section>
					...
					<div class="row">
						<div class="col s12">
							<h5 class="grey-text text-darken-4"><i class="material-icons hiddenprint">info_outline</i> SOBRE CLEVER</h5>
						</div>
					</div>
					<div class="row">
						...
						<div class="col s12 xl6">
							<h5><i class="material-icons hiddenprint">info</i> Informações Gerais</h5>
							<ul class="collapsible popout" data-collapsible="accordion" id="info_collapsible">
								<li>
									<!-- Cabeçalho de um item da lista -->
									<div class="collapsible-header"><i class="material-icons hiddenprint">person_pin</i>Onde estamos</div>
								...
								<li>
									<div class="collapsible-header active"><i class="material-icons hiddenprint">perm_identity</i>Quem somos</div>
								...
								<li>
									<div class="collapsible-header"><i class="material-icons hiddenprint">star</i>Artistas</div>
								...
								<li>
									<div class="collapsible-header"><i class="material-icons hiddenprint">work</i>Processo de audições</div>
									<!-- No conteúdo desse item da lista também é feito uso do componente 'badge' -->
								...
								<li>
									<div class="collapsible-header"><i class="material-icons hiddenprint">chat_bubble_outline</i>Contate-nos</div>
						...
						<div class="col s12 m5 offset-m1 hiddenprint">
							<h5><i class="material-icons hiddenprint">person_pin</i> Clever Entertainment no Brasil</h5>
							<figure>
						...
						<div class="col s12 m5 offset-m1 hiddenprint">
							<h5><i class="material-icons hiddenprint">business</i> Parceiros</h5>
